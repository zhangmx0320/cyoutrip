...
import com.cyoutrip.bean.City;
import com.cyoutrip.util.PingYinUtil;
import com.cyoutrip.view.MyLetterListView;

public class CitySelectActivity extends AppCompatActivity implements OnScrollListener {
...
//	private DatabaseHelper helper;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(this.getSupportActionBar()!=null){
			this.getSupportActionBar().setTitle("定位城市");
...
//			e.printStackTrace();
//		}
		list.add(new City("北京","beijing"));
		list.add(new City("上海","shanghai"));
		list.add(new City("广州","guangzhou"));
		list.add(new City("深圳","shenzhen"));
		list.add(new City("天津","tianjin"));
		list.add(new City("哈尔滨","harbin"));
		list.add(new City("伊春","yichun"));
		list.add(new City("长春","changchun"));
...
//			e.printStackTrace();
//		}
		city_result.add(new City("北京","beijing"));
		city_result.add(new City("上海","shanghai"));
		city_result.add(new City("广州","guangzhou"));
		city_result.add(new City("深圳","shenzhen"));
		city_result.add(new City("天津","tianjin"));
		city_result.add(new City("哈尔滨","harbin"));
		city_result.add(new City("伊春","yichun"));
		city_result.add(new City("长春","changchun"));
